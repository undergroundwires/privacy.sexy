...
describe('CategoryCollectionFactory', () => {
  describe('createCategoryCollection', () => {
...
function getValidScriptingDefinition(): ScriptingDefinition {
  return {
    fileExtension: '.bat',
...
class TestContext {
  ...
  private scriptingDefinition: ScriptingDefinition = getValidScriptingDefinition();
  ...
  public withScripting(scriptingDefinition: ScriptingDefinition): this {
