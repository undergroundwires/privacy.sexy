...
<<<<<<<< HEAD:tests/unit/application/Parser/Executable/Script/CategoryCollectionParseContext.spec.ts
import { CategoryCollectionParseContext } from '@/application/Parser/Executable/CategoryCollectionParseContext';
