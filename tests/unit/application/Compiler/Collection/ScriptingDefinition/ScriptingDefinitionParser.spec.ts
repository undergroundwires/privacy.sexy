...
import { parseScriptingDefinition } from '@/application/Compiler/Collection/ScriptingDefinition/ScriptingDefinitionParser';
import type { ObjectAssertion, TypeValidator } from '@/application/Compiler/Common/TypeValidator';
  ...
  describe('parseScriptingDefinition', () => {
    ...
    describe('substitutes code as expected', () => {
      ...
      const testScenarios: readonly {
        ...
        getActualValue(result: ScriptingDefinition): string;
        readonly data: ScriptingDefinitionData;
      }[] = [
        {
          description: 'startCode',
          getActualValue: (result: ScriptingDefinition) => result.startCode,
          data: new ScriptingDefinitionDataStub()
            .withStartCode(code),
        },
        {
          description: 'endCode',
          getActualValue: (result: ScriptingDefinition) => result.endCode,
          data: new ScriptingDefinitionDataStub()
            .withEndCode(code),
        },
      ];
